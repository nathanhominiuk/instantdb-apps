...
export default function EventDetail({ event, onClose }: EventDetailProps) {
  ...
  const timeStr = event.allDay
    ? "All day"
    : formatTimeRange(event.startTime, event.endTime, settings.timeFormat);
        ...
        <div className="p-5">
          ...
          <div className="space-y-3 mt-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm text-gray-900 dark:text-gray-100">{dateStr}</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">{timeStr}</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  {calendarName}
                  {ownerName && <span className="text-gray-400 dark:text-gray-500"> ({ownerName})</span>}
                </span>
              </div>
            </div>
          </div>
